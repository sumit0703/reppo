...
namespace DynamoDBService
{
    public static partial class Ddb_Intro
    {
        ...
        static string shortFormatStrA = "\n         {0}:  \"{1}\"\n" +
                                         "                  -- lead: {2}\n" +
                                         "                  -- genres: {3}\n" +
                                         "                  -- running time: {4}";
        static string shortFormatStrB = " \n        {0}:  \"{1}\"\n" +
                                         "                  -- lead: {2}\n" +
                                         "                  -- director(s): {3}\n" +
                                         "                  -- running time: {4}";
        ...
        public static void showMovieAttrsShort(Dictionary<string, AttributeValue> movie)
        {
            ...
            if (info.ContainsKey("genres"))
                msg.AppendFormat(shortFormatStrA, movie["year"].N, movie["title"].S,
                                   firstAttrValToString(info["actors"]),
                                   attrValToString(info["genres"], 0), rtm);
            else if (info.ContainsKey("directors"))
                msg.AppendFormat(shortFormatStrB, movie["year"].N, movie["title"].S,
                                   firstAttrValToString(info["actors"]),
        ...
        public static void showMovieDocShort(Document movie)
        {
            ...
            if (infoDoc.ContainsKey("genres"))
                msg.AppendFormat(shortFormatStrA, movie["year"], movie["title"],
                ...
                msg.AppendFormat(shortFormatStrB, movie["year"], movie["title"],
                                   infoDoc["actors"].AsArrayOfString()[0],
